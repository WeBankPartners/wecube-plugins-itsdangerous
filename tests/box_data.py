...
complex_boxes = [{'description': '生产核心系统',
  'id': 1,
  'name': '生产核心',
  'policy': {'description': '生产核心最高级别检查',
             'enabled': 1,
             'id': 1,
             'name': '生产核心最高级别检查',
             'rules': [{'description': '全量文件删除',
                        'effect_on': 'script',
                        'enabled': 1,
                        'id': 1,
                        'level': 1,
                        'match_param': {'description': '文件删除',
                                        'id': 2,
                                        'name': 'rm',
                                        'params': {'args': [{'action': 'store_true',
                                                             'name': 'force',
                                                             'shortcut': '-f,--force'},
                                                            {'action': 'store_true',
                                                             'name': 'recursive',
                        ...
                        'match_param_id': 2,
                        'match_type': 'cli',
                        'match_value': '[{"name": "force", "operator": "set"}, '
                       ...
                       {'description': 'drop table',
                        ...
                        'id': 5,
                        'level': 0,
                        'match_param': {'description': '针对大小写不敏感的场景',
                                        'id': 1,
                                        'name': 'iregex',
                                        'params': {'flag': 'I'},
                                        'type': 'regex'},
                       ...
                       {'description': 'kill -9',
                        ...
                        'id': 13,
                        'level': 2,
                        'match_param': {'description': '进程关闭',
                                        'id': 3,
                                        'name': 'kill',
                                        'params': {'args': [{'name': 'name',
                                                             'shortcut': '-s'},
                                                            {'name': 'number',
                                                             'shortcut': '-n'},
                                                            {'action': 'store_true',
  ...
  'policy_id': 1,
  'subject': {'description': '生产核心系统',
              'enabled': 1,
              'id': 1,
              'name': 'CORE_SYSTEM',
              'targets': [{'args_scope': '{serviceName eq '
                                         "'qcloud/vm(resource)/action'}{inputParams.name "
                                         "eq 'destroy'}",
                           'enabled': 1,
                           'entity_scope': 'wecmdb:deploy_environment{guid eq '
                                           "'0003_0000000001'}~(deploy_environment)wecmdb:app_system~(app_system)wecmdb:subsys{key_name "
                                           'eq '
                                           "'PRD_TaDEMO_CORE'}~(subsys)wecmdb:unit~(unit)wecmdb:app_instance.host_resource_instance>wecmdb:host_resource_instance",
                           'id': 1,
                           'name': '核心生产'},
                          {'args_scope': '{serviceName eq '
                                         "'qcloud/vm(resource)/action'}{inputParams.name "
                                         "eq 'destroy'}",
                           'enabled': 1,
                           'entity_scope': 'wecmdb:deploy_environment{guid eq '
                                           "'0003_0000000002'}~(deploy_environment)wecmdb:app_system~(app_system)wecmdb:subsys{key_name "
                                           'eq '
                                           "'PRD_TaDEMO_CORE'}~(subsys)wecmdb:unit~(unit)wecmdb:app_instance.host_resource_instance>wecmdb:host_resource_instance",
                           'id': 2,
                           'name': '核心灾备'},
  ...
  'policy': {'description': '生产核心最高级别检查',
             ...
             'rules': [{'description': '全量文件删除',
                       ...
                       {'description': 'kill -9',
                        ...
                        'name': '强制kill(cli-9/15)'}]},
  'policy_id': 1,
  'subject': {'description': '生产核心系统NULL',
              'enabled': 1,
              'id': 2,
              'name': 'NULL_CORE_SYSTEM',
              'targets': [{'args_scope': '{serviceName eq '
                                         "'qcloud/vm(resource)/action'}{inputParams.name "
                                         "eq 'create'}",
                           'enabled': 1,
...
nocmdb_boxes = [{'description': '生产核心系统',
  'id': 1,
  'name': '生产核心',
  'policy': {'description': '生产核心最高级别检查',
             'enabled': 1,
